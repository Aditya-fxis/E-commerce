...
//         alt="Hero Image"
//       />
//       <div className="absolute left-1/3 pl-48 top-96 transform -translate-x-1/2 -translate-y-1/2 text-left">
//         <p className=" text-red-600 text-sm mb-8 font-semibold uppercase tracking-[4px]">Summer Collection</p>
//         <h1 className="text-black text-5xl font-bold w-[60%] font1 tracking-[2px] leading-[56px]">Fall - Winter Collections 2030</h1>
//         <p className="mt-8 mb-8 w-[55%] leading-7 text-gray-700">A specialist label creating luxury essentials. Ethically crafted with an unwavering commitment to exceptional quality.</p>
//         <button className="flex items-center uppercase tracking-[3px] bg-black text-white p-3 px-10 text-sm font-semibold"> Shop Now
//           <span className="text-3xl font-bold ml-2">
//             <IoIosArrowRoundForward />
//             </span>
//             </button>
//             <div className="flex gap-4 text-xl text-gray-500 top-140 absolute">
//             <TiSocialFacebook />
//             <TiSocialTwitter />
//             <FaPinterest />
//             <FaInstagram />
